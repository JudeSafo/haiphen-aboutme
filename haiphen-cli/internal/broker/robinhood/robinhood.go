...
func init() {
	broker.Register("robinhood", func(apiKey, apiSecret string) broker.Broker {
		return &Stub{}
	})
}

// Stub is a placeholder for future Robinhood integration.
type Stub struct{}

func (s *Stub) Name() string { return "robinhood" }

var errComingSoon = fmt.Errorf("Robinhood integration is coming soon. Use Alpaca for paper trading")
