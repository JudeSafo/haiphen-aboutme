...
func init() {
	broker.Register("blackstone", func(apiKey, apiSecret string) broker.Broker {
		return &Stub{}
	})
}

// Stub is a placeholder for future Blackstone integration.
type Stub struct{}

func (s *Stub) Name() string { return "blackstone" }

var errComingSoon = fmt.Errorf("Blackstone integration is coming soon. Use Alpaca for paper trading")
