...
func init() {
	broker.Register("fidelity", func(apiKey, apiSecret string) broker.Broker {
		return &Stub{}
	})
}

// Stub is a placeholder for future Fidelity integration.
type Stub struct{}

func (s *Stub) Name() string { return "fidelity" }

var errComingSoon = fmt.Errorf("Fidelity integration is coming soon. Use Alpaca for paper trading")
