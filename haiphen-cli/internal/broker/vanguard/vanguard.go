...
func init() {
	broker.Register("vanguard", func(apiKey, apiSecret string) broker.Broker {
		return &Stub{}
	})
}

// Stub is a placeholder for future Vanguard integration.
type Stub struct{}

func (s *Stub) Name() string { return "vanguard" }

var errComingSoon = fmt.Errorf("Vanguard integration is coming soon. Use Alpaca for paper trading")
