...
func init() {
	broker.Register("ibkr", func(apiKey, apiSecret string) broker.Broker {
		return &Stub{}
	})
}

// Stub is a placeholder for future Interactive Brokers integration.
type Stub struct{}

func (s *Stub) Name() string { return "ibkr" }

var errComingSoon = fmt.Errorf("Interactive Brokers integration is coming soon. Use Alpaca for paper trading")
